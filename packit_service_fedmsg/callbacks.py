...
MAPPING = {
    ...
    # TODO placeholder topic names (actual names have not yet been determined)
    "org.fedoraproject.prod.forgejo.git.receive": _fedora_dg_push,
    "org.fedoraproject.prod.forgejo.pull-request.new": _fedora_dg_pr_new,
    "org.fedoraproject.prod.forgejo.pull-request.updated": _fedora_dg_pr_updated,
    "org.fedoraproject.prod.forgejo.pull-request.rebased": _fedora_dg_pr_rebased,
    "org.fedoraproject.prod.forgejo.pull-request.flag.added": _fedora_dg_pr_flag,
    "org.fedoraproject.prod.forgejo.pull-request.flag.updated": _fedora_dg_pr_flag,
    "org.fedoraproject.prod.forgejo.pull-request.comment.added": _fedora_dg_pr_comment,
    "org.fedoraproject.prod.forgejo.pull-request.closed": _fedora_dg_pr_closed,
